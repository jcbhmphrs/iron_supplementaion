...
def main():
    readings = {}
    lot_lable = Label(root, text='Lot Number:')
    lot_entry = Entry(root, width=30)
    lot_lable.grid(row=0, column=0)
    ...
    uibc_initial_standard_label=Label(uibc_initial_labelframe,bg='#ffffe6', text='Standard')
    uibc_initial_standard_label.pack(padx=5, pady=3)
    uibc_initial_standard=FloatEntry(uibc_initial_labelframe, width=10)
    #take out later
    uibc_initial_standard.insert(END,'0.001')
    uibc_initial_standard.pack(padx=5, pady=3)

    uibc_initial_test_label=Label(uibc_initial_labelframe, bg='#ffffe6',text= 'Test')
    uibc_initial_test_label.pack(padx=5, pady=3)
    uibc_initial_test=FloatEntry(uibc_initial_labelframe, width=10)
    #take out later
    uibc_initial_test.insert(END,'0.019')
    uibc_initial_test.pack(padx=5, pady=3)

    uibc_initial_control_label=Label(uibc_initial_labelframe,bg='#ffffe6', text='Control')
    uibc_initial_control_label.pack(padx=5, pady=3)
    uibc_initial_control=FloatEntry(uibc_initial_labelframe, width=10)
    #take out later
    ...
    iron_initial_standard_label=Label(iron_initial_labelframe,bg='#ff9999',text='Standard')
    iron_initial_standard_label.pack(padx=5, pady=3)
    iron_initial_standard=FloatEntry(iron_initial_labelframe,width=10)
    #take out later
    iron_initial_standard.insert(END,'0.002')
    iron_initial_standard.pack(padx=5, pady=3)

    iron_initial_test_label=Label(iron_initial_labelframe,bg='#ff9999',text='Test')
    iron_initial_test_label.pack(padx=5, pady=3)
    iron_initial_test=FloatEntry(iron_initial_labelframe,width=10)
    #take out later
    iron_initial_test.insert(END,'0.011')
    iron_initial_test.pack(padx=5, pady=3)

    iron_initial_control_label=Label(iron_initial_labelframe,bg='#ff9999',text='Control')
    iron_initial_control_label.pack(padx=5, pady=3)
    iron_initial_control=FloatEntry(iron_initial_labelframe,width=10)
    #take out later
    ...
    uibc_final_standard_label=Label(uibc_final_labelframe,bg='#ffffe6', text='Standard')
    uibc_final_standard_label.pack(padx=5, pady=3)
    uibc_final_standard=FloatEntry(uibc_final_labelframe, width=10)
    #take out later
    uibc_final_standard.insert(END,'0.437')
    uibc_final_standard.pack(padx=5, pady=3)

    uibc_final_test_label=Label(uibc_final_labelframe,bg='#ffffe6', text='Test')
    uibc_final_test_label.pack(padx=5, pady=3)
    uibc_final_test=FloatEntry(uibc_final_labelframe, width=10)
    #take out later
    uibc_final_test.insert(END,'0.315')
    uibc_final_test.pack(padx=5, pady=3)

    uibc_final_control_label=Label(uibc_final_labelframe,bg='#ffffe6', text='Control')
    uibc_final_control_label.pack(padx=5, pady=3)
    uibc_final_control=FloatEntry(uibc_final_labelframe, width=10)
    #take out later
    ...
    iron_final_standard_label=Label(iron_final_labelframe,bg='#ff9999',text='Standard')
    iron_final_standard_label.pack(padx=5, pady=3)
    iron_final_standard=FloatEntry(iron_final_labelframe,width=10)
    #take out later
    iron_final_standard.insert(END,'0.401')
    iron_final_standard.pack(padx=5, pady=3)

    iron_final_test_label=Label(iron_final_labelframe,bg='#ff9999',text='Test')
    iron_final_test_label.pack(padx=5, pady=3)
    iron_final_test=FloatEntry(iron_final_labelframe,width=10)
    #take out later
    iron_final_test.insert(END,'0.256')
    iron_final_test.pack(padx=5, pady=3)

    iron_final_control_label=Label(iron_final_labelframe,bg='#ff9999',text='Control')
    iron_final_control_label.pack(padx=5, pady=3)
    iron_final_control=FloatEntry(iron_final_labelframe,width=10)
    #take out later
    ...
    results_b=Button(root,bg='#b3ff99',text='Get Results',pady=10, command=get_calculations)
    results_b.grid(row=2,columnspan=2,pady=20)
    root.mainloop()
main()
